...
// for GET(get user list) and POST(create user)
// https://url.com/api/v1/users (same url)
// on body: { "username": "yourUserName", "password": "yourPassword" }
...
// Change password
// https://url.com/api/v1/users/:username
// on body: { "username": "yourUserName", "password": "newPassword"
