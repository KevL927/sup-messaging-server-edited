...
// get text record from one user to another
// url: https://url.com/api/v1/messages/
...
// create new text from one user to another
// url: https://url.com/api/v1/messages/
// json body: { "from": "5833295f5f156c10432a8167", "to": "58332ad85f156c10432a8168", "text": "hello" }
  .post((req, res) => {
...
// url: https://sup-messaging-app-frontend-kl012.c9users.io/api/v1/messages/message._id
messagesRouter
  .route('/:messageId')
  .get((req, res) => {
    Message
